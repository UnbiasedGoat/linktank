...
<div class = "nex" style="float:left;margin-top:10px;margin-left:10px;">
<form action = "account.php" method="post">
<input class = "postes" type ="submit" name="poster2" value="Account Settings!"/>
</form>
<br>
<br>
<form action = "postform.php" method="post">
<input class = "postes" type ="submit" name="poster" value="Make A Post!"/>
</form>
</div>
</div>
